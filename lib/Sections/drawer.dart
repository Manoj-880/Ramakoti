          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                color:
                    widget.selectedindex == 1 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'About',
            ...
            GestureDetector(
              ...
              child: Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 18, horizontal: 30),
                color:
                    widget.selectedindex == 2 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'My Profile',
                  style: TextStyle(fontSize: 20, color: Color(0xffffffff)),
            ...
            GestureDetector(
              ...
              child: Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 18, horizontal: 30),
                color:
                    widget.selectedindex == 3 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'Writing Pad',
                  style: TextStyle(fontSize: 20, color: Color(0xffffffff)),
            ...
            GestureDetector(
              ...
              child: Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 18, horizontal: 30),
                color:
                    widget.selectedindex == 4 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'Leaderboard',
                  style: TextStyle(fontSize: 20, color: Color(0xffffffff)),
            ...
            GestureDetector(
              ...
              child: Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 18, horizontal: 30),
                color:
                    widget.selectedindex == 5 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'My Rewards',
                  style: TextStyle(fontSize: 20, color: Color(0xffffffff)),
            ...
            GestureDetector(
              ...
              child: Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 18, horizontal: 30),
                color:
                    widget.selectedindex == 6 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'Global Dashboard',
                  style: TextStyle(fontSize: 20, color: Color(0xffffffff)),
            ...
            GestureDetector(
              ...
              child: Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 18, horizontal: 30),
                color:
                    widget.selectedindex == 7 ? Colors.red : Colors.transparent,
                width: size.width,
                child: const Text(
                  'Feedback',
                  style: TextStyle(fontSize: 20, color: Color(0xffffffff)),
